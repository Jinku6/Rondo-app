    ...
    <ScrollView className="flex-1 bg-slate-50 dark:bg-neutral-950 p-6" contentContainerStyle={{ paddingBottom: 40 }}>
      <View className="bg-white dark:bg-gray-900 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-800 items-center">
        ...
        <View className="flex-row w-full justify-around border-t border-gray-200 dark:border-gray-800 pt-6 mt-6">
          ...
          <View className="items-center">
            <Text className="text-3xl font-bold text-emerald-500">{profile.reliability_score}%</Text>
            <Text className="text-slate-500 dark:text-slate-400 text-xs uppercase mt-1">Fiabilidad</Text>
          </View>
        </View>
        ...
        <View className="flex-row w-full justify-around mt-6 bg-slate-50 dark:bg-slate-900 p-4 rounded-2xl border border-slate-100 dark:border-slate-800">
          <View className="items-center justify-center">
            <Text className="text-emerald-600 dark:text-emerald-400 font-bold mb-1">Nivel</Text>
            <Text className="text-xl font-black text-slate-800 dark:text-slate-200">{profile.average_level > 0 ? profile.average_level.toFixed(1) : 'N/A'}</Text>
          </View>
          <View className="items-center justify-center">
            <Text className="text-amber-600 dark:text-amber-400 font-bold mb-1">Actitud</Text>
            <Text className="text-xl font-black text-slate-800 dark:text-slate-200">{getAttitudeEmojis(profile.average_attitude)}</Text>
          </View>
        </View>
      </View>
